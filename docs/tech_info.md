...
1. When notes are created or modified, Obsidian raises some events. RuSync catches these events and reflects changes into Local PouchDB.
...
4. RuSync reflects replicated changeset into Obsidian's vault.
