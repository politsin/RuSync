...
2. Select the `Welcome to RuSync` Notice to open onboarding.
...
2. Run `RuSync: Copy settings as a new Setup URI`.
...
1. Install and enable RuSync in the intended Vault.
2. Select the `Welcome to RuSync` Notice, choose `I am setting this up for the first time`, then confirm that you want to set up a new synchronisation.
