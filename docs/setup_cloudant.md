...
1. In resource details, there is information to connect from RuSync.  
...
1.  If the database was shown with joyful messages, the setup is almost done.  
    ...
    You can create a database from RuSync.
...
1.  The dialogue to create a credential will be shown.  
    ...
    _NOTE: This "name" is not related to your username that uses in RuSync._
