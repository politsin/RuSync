export const allMessages: Readonly<Record<string, Readonly<Record<string, string>>>> = {
    ...
    "Delete local database to reset or uninstall RuSync": {
        def: "Delete local database to reset or uninstall RuSync",
        es: "Eliminar la base de datos local para restablecer o desinstalar RuSync",
        ja: "RuSync をリセットまたはアンインストールするため、ローカルデータベースを削除",
        ko: "RuSync를 초기화하거나 제거하기 위해 로컬 데이터베이스를 삭제",
        ru: "Удалить локальную базу данных, чтобы сбросить или удалить RuSync",
        zh: "删除本地数据库以重置或卸载 RuSync",
        "zh-tw": "刪除本機資料庫以重設或解除安裝 RuSync",
    },
    ...
    "Doctor.Dialogue.Title": {
        def: "RuSync Config Doctor",
        es: "Doctor de configuración de RuSync",
        fr: "Docteur Config RuSync",
        he: "RuSync Config Doctor",
        ja: "RuSync 設定診断ツール",
        ko: "RuSync 구성 진단 마법사",
        ru: "Диагностика RuSync",
        zh: "RuSync 配置诊断",
        "zh-tw": "RuSync 設定診斷",
    },
    ...
    "In this scenario, RuSync will recreate metadata for every file and deliberately generate conflicts. Where the file content is identical, these conflicts will be resolved automatically.":
        {
            def: "In this scenario, RuSync will recreate metadata for every file and deliberately generate conflicts. Where the file content is identical, these conflicts will be resolved automatically.",
            es: "En este caso, RuSync recreará los metadatos de todos los archivos y generará conflictos a propósito. Cuando el contenido del archivo sea idéntico, esos conflictos se resolverán automáticamente.",
            ko: "이 경우 RuSync는 모든 파일의 메타데이터를 다시 만들면서 의도적으로 충돌을 발생시킵니다. 파일 내용이 동일한 경우 이러한 충돌은 자동으로 해결됩니다.",
            "zh-tw":
                "在這種情況下，RuSync 會為每個檔案重新建立中繼資料，並刻意產生衝突。若檔案內容相同，這些衝突會自動解決。",
        },
    "Incoming:": {
        def: "Incoming:",
        es: "Entrantes:",
    ...
    "liveSyncReplicator.remoteDbCorrupted": {
        def: "Remote database is newer or corrupted, make sure to latest version of rusync installed",
        es: "La base de datos remota es más nueva o está dañada, asegúrese de tener la última versión de rusync instalada",
        fr: "La base distante est plus récente ou corrompue, assurez-vous d'avoir installé la dernière version de rusync",
        he: "מסד הנתונים המרוחק חדש יותר או פגום, ודא שגרסת rusync המותקנת היא העדכנית ביותר",
        ja: "リモートデータベースが新しいか破損しています。rusyncの最新バージョンがインストールされていることを確認してください",
        ko: "원격 데이터베이스가 더 최신이거나 손상되었습니다. 최신 버전의 rusync가 설치되어 있는지 확인하세요",
        ru: "Удалённая база данных новее или повреждена, убедитесь, что установлена последняя версия rusync",
        zh: "远程数据库较新或已损坏,请确保已安装最新版本的rusync",
        "zh-tw": "遠端資料庫版本較新或已損毀，請確保已安裝最新版本的 RuSync",
    },
    ...
    "moduleLiveSyncMain.logPluginVersion": {
        def: "RuSync v${manifestVersion} ${packageVersion}",
        es: "RuSync v${manifestVersion} ${packageVersion}",
        fr: "RuSync v${manifestVersion} ${packageVersion}",
        he: "RuSync גרסה ${manifestVersion} ${packageVersion}",
        ja: "RuSync v${manifestVersion} ${packageVersion}",
        ko: "RuSync v${manifestVersion} ${packageVersion}",
        ru: "RuSync vmanifestVersion packageVersion",
        zh: "RuSync v${manifestVersion} ${packageVersion}",
    },
    ...
    "obsidianLiveSyncSettingTab.descConnectSetupURI": {
        def: "This is the recommended method to set up RuSync with a Setup URI.",
        es: "Este es el método recomendado para configurar RuSync con una URI de configuración.",
        fr: "Méthode recommandée pour configurer RuSync avec une URI de configuration.",
        he: "זוהי השיטה המומלצת להגדרת RuSync עם Setup URI.",
        ja: "セットアップURIを使用してRuSyncをセットアップする推奨方法です。",
        ko: "이것은 Setup URI로 RuSync를 설정하는 권장 방법입니다.",
        ru: "Это рекомендуемый способ настройки RuSync с помощью Setup URI.",
        zh: "这是使用设置 URI 设置 RuSync 的推荐方法",
        "zh-tw": "這是使用 Setup URI 設定 RuSync 的建議方式。",
    },
    ...
    "Rerun the onboarding wizard to set up RuSync again.": {
        def: "Rerun the onboarding wizard to set up RuSync again.",
        es: "Vuelve a ejecutar el asistente de configuración inicial para configurar RuSync de nuevo.",
        fr: "Relancer l'assistant d'intégration pour reconfigurer RuSync.",
        he: "הרץ שוב את אשף ההכוונה להגדרת RuSync מחדש.",
        ja: "オンボーディングウィザードを再実行して、RuSync をもう一度設定します。",
        ko: "온보딩 마법사를 다시 실행하여 RuSync를 다시 설정합니다.",
        ru: "Перезапустить мастер настройки для повторной настройки RuSync.",
        zh: "重新运行引导向导以再次设置 RuSync。",
        "zh-tw": "重新執行導覽精靈以再次設定 RuSync。",
    },
    "Rerun Wizard": {
        def: "Rerun Wizard",
    ...
    "Ui.SetupWizard.Intro.Title": {
        def: "Welcome to RuSync",
        es: "Bienvenido a RuSync",
        ko: "RuSync에 오신 것을 환영합니다",
        zh: "欢迎使用 RuSync",
        "zh-tw": "歡迎使用 RuSync",
    },
